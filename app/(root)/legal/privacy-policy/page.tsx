    ...
    <>
      <div id="privacypolicy" className="pt-40 font-light">
        ...
        <main className="relative text-xl">
          ...
          <br />
          <br />
          <h1 className="subHeadPvcH2 font-semibold text-3xl">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Celeste Consulting, #319, Mysuru.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                accessible from{" "}
                <a href="https://celesteconsulting.in" target="_blank">
          ...
          <br />
          <h3 className="subHeadPvc text-2xl">Personal Data</h3>
          <p>
